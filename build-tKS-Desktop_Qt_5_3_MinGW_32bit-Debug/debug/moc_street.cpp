...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_street_t, stringdata) + ofs \
...
const QMetaObject street::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_street.data,
      qt_meta_data_street,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_street.stringdata))
        return static_cast<void*>(const_cast< street*>(this));
